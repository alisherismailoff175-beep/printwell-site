...
(function () {
  ...
  var I18N = {
    ru: {
      ...
      'prj.p2.title': 'Каталог и брошюры для IT-компании',
      'prj.p3.title': 'Ярлыки для fashion-бренда',
      'prj.p4.title': 'Фольгирование коробок для косметики',
      'prj.p5.title': 'Визитки с Spot UV для банка',
      'prj.p6.title': 'Мерч с логотипом для корпоратива',
      'prj.p7.title': 'Упаковка для кондитерской',
      'prj.p8.title': 'Блокноты и папки для госструктуры',
      'prj.p9.title': 'Тиснение и ламинация для luxury-бренда',
    ...
    uz: {
      ...
      'prj.p2.title': 'IT-kompaniya uchun katalog va broshyuralar',
      'prj.p3.title': 'Fashion-brend uchun yorliqlar',
      'prj.p4.title': 'Kosmetika qutilari uchun folga bosish',
      'prj.p5.title': 'Bank uchun Spot UV vizitkalar',
      'prj.p6.title': 'Korporativ tadbir uchun logotipli merch',
      'prj.p7.title': 'Qandolat sexi uchun qadoqlash',
      'prj.p8.title': 'Davlat tashkiloti uchun bloknot va papkalar',
      'prj.p9.title': 'Luxury-brend uchun tiqinlash va laminatsiya',
    ...
    en: {
      ...
      'prj.p2.title': 'Catalogue & brochures for an IT company',
      'prj.p3.title': 'Tags for a fashion brand',
      'prj.p4.title': 'Foil stamping on cosmetics boxes',
      'prj.p5.title': 'Spot UV business cards for a bank',
      'prj.p6.title': 'Branded merch for a corporate event',
      'prj.p7.title': 'Packaging for a confectionery',
      'prj.p8.title': 'Notebooks & folders for a government body',
      'prj.p9.title': 'Embossing & lamination for a luxury brand',
